  ...
  return (
    <Box maxW="80%" margin="auto">
      <Text>
        ...
        You’re not allowed to attempt to extract the source code of the app, and
        you also shouldn’t try to translate the app into other languages or make
        derivative versions. The app itself, and all the trademarks, copyright,
        database rights, and other intellectual property rights related to it,
        still belong to Matteo Di Rollo. Matteo Di Rollo is committed to
        ensuring that the app is as useful and efficient as possible. For that
        reason, we reserve the right to make changes to the app or to charge for
        its services, at any time and for any reason. We will never charge you
        for the app or its services without making it very clear to you exactly
        what you’re paying for. The matteo-dirollo app stores and processes
        personal data that you have provided to us, to provide my Service. It’s
        ...
        phone’s security features and it could mean that the matteo-dirollo app
        won’t work properly or at all. The app does use third-party services
        that declare their Terms and Conditions. Link to Terms and Conditions of
        third-party service providers used by the app Google Play Services
        Google Analytics for Firebase Facebook You should be aware that there
        are certain things that Matteo Di Rollo will not take responsibility
        ...
        mobile network provider, but Matteo Di Rollo cannot take responsibility
        for the app not working at full functionality if you don’t have access
        to Wi-Fi, and you don’t have any of your data allowance left. If you’re
        using the app outside of an area with Wi-Fi, you should remember that
        the terms of the agreement with your mobile network provider will still
        apply. As a result, you may be charged by your mobile provider for the
        cost of data for the duration of the connection while accessing the app,
        or other third-party charges. In using the app, you’re accepting
        responsibility for any such charges, including roaming data charges if
        you use the app outside of your home territory (i.e. region or country)
        without turning off data roaming. If you are not the bill payer for the
        device on which you’re using the app, please be aware that we assume
        that you have received permission from the bill payer for using the app.
        Along the same lines, Matteo Di Rollo cannot always take responsibility
        ...
        avail the Service, Matteo Di Rollo cannot accept responsibility. With
        respect to Matteo Di Rollo’s responsibility for your use of the app,
        ...
        it available to you. Matteo Di Rollo accepts no liability for any loss,
        ...
        The app is currently available on Android & iOS – the requirements for
        ...
        updates if you want to keep using the app. Matteo Di Rollo does not
        ...
        conditions are effective as of 2022-09-24 Contact Us If you have any
        questions or suggestions about my Terms and Conditions, do not hesitate
        to contact me at matteo.dirollo@icloud.com. This Terms and Conditions
