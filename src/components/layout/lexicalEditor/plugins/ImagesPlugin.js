...
export function InsertImageUriDialogBody({ onClick, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TextInput, { label: "Image URL", placeholder: "i.e. https://source.unsplash.com/random", onChange: setSrc, value: src, "data-test-id": "image-modal-url-input" }),
        React.createElement(TextInput, { label: "Alt Text", placeholder: "Random unsplash image", onChange: setAltText, value: altText, "data-test-id": "image-modal-alt-text-input" }),
...
export function InsertImageUploadedDialogBody({ onClick, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(FileInput, { label: "Image Upload", onChange: loadImage, accept: "image/*", "data-test-id": "image-modal-file-upload" }),
        ...
        React.createElement(DialogActions, null,
            React.createElement(Button, { "data-test-id": "image-modal-file-upload-btn", disabled: isDisabled, onClick: () => onClick({ altText, src }) }, "Confirm"))));
}
export function InsertImageDialog({ activeEditor, onClose, }) {
    ...
    return (React.createElement(React.Fragment, null,
        !mode && (React.createElement(DialogButtonsList, null,
            ...
            React.createElement(Button, { "data-test-id": "image-modal-option-url", onClick: () => setMode('url') }, "URL"),
            React.createElement(Button, { "data-test-id": "image-modal-option-file", onClick: () => setMode('file') }, "File"))),
